...
public:
	CTransform();
	CTransform(glm::vec3 pos, glm::vec3 rotation = { 0,0,0 }, glm::vec3 scale = { 1,1,1 }, CTransform* parent = nullptr) { m_parent = parent; SetAbsOrigin(pos); SetAbsAngles(rotation); SetAbsScale(scale); }
